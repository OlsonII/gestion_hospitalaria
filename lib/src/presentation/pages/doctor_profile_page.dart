...
class DoctorProfilePage extends StatelessWidget {
  ...
  DoctorProfilePage(this._doctor);

  @override
  Widget build(BuildContext context) {
    medicalAppointmentBloc.sendMedicalAppointmentEvent.add(SearchMedicalAppointmentEvent(personId: _doctor.identification, isPatient: false));
    return Container(
          ...
          Row(
              children: [
                ...
                Column(
                  ...
                  children: [
                    Text('Identificacion: ${_doctor.identification}'),
                    SizedBox(height: 7.0),
                    Text('Nombre: ${_doctor.name} ${_doctor.surname}'),
                    SizedBox(height: 7.0),
                    Text('Genero: ${_doctor.gender}'),
                    SizedBox(height: 7.0),
                    Text('Titulo: ${_doctor.degree} - Jornada: ${_doctor.workday}')
                  ],
                )
              ]),
