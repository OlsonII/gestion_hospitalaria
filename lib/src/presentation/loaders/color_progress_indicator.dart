...
class ColorProgressIndicator extends StatefulWidget {
  ...
  ColorProgressIndicator({this.color1 = Colors.deepOrangeAccent, this.color2 = Colors.yellow, this.color3 = Colors.lightGreen});

  @override
  _ColorProgressIndicatorState createState() => _ColorProgressIndicatorState();
}

class _ColorProgressIndicatorState extends State<ColorProgressIndicator> with TickerProviderStateMixin {
